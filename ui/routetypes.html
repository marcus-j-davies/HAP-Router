...
<body>
   <blockquote class="ContentSection">
         <div class="ContentTitle">Choose Route type
            ...
            <fieldset>
             {{#Types}}
             <div class="OptionBox" onclick="location.href='../../../ui/createroute/?type={{type}}'">
               <img class="AccessoryIcon" style="margin-bottom: 5px;" src="../../../ui/resources/routeicon/?type={{type}}"><br />
               {{label}}
            </div>
             {{/Types}}
