...
<body>
   <blockquote class="ContentSection">
      <div class="ContentTitle"> <img class="AccessoryIcon" style="margin-bottom: 5px;width: unset;" src="../../../ui/resources/routeicon/?type={{type}}" invert> Edit Route, {{name}}
               ...
               <table>
                  {{#Settings}}
                        ...
                        <tr>
                           ...
                           <td><input type="text" data-param="{{id}}" class="RouteParam" value="{{value}}""></td>
                        </tr>
         ...
         <fieldset style="text-align: right; margin-top: 20px;">
            <span style="color: rgb(255,255,255);" id="Message"></span> <input type="button" class="StyledButton" value="Delete" onclick="" {{#if inUse}}disabled{{/if}}> <input type="button" class="StyledButton" value="Save" onclick="SaveRouteChanges('{{name}}')">
          </fieldset>
